...
let value = 3
let negValue = -value  //assigns negative of value to variable negValue
...
/*This means that if string is given first then it will be treated as a string.
But if numbers are given first then  */
